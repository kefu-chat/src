...
namespace PHPSTORM_META {
    ...
    * Generated on 2020-08-16 08:19:34.
    *
    ...
    */
    ...
    override(\Illuminate\Database\Eloquent\Concerns\HasRelationships::morphOne(0), map(['' => '@|\Illuminate\Database\Eloquent\Relations\MorphOne',]));
    override(\Illuminate\Database\Eloquent\Concerns\HasRelationships::belongsTo(0), map(['' => '@|\Illuminate\Database\Eloquent\Relations\BelongsTo',]));
    override(\Illuminate\Database\Eloquent\Concerns\HasRelationships::morphTo(0), map(['' => '@|\Illuminate\Database\Eloquent\Relations\MorphTo',]));
    override(\Illuminate\Database\Eloquent\Concerns\HasRelationships::hasMany(0), map(['' => '@|\Illuminate\Database\Eloquent\Relations\HasMany',]));
    override(\Illuminate\Database\Eloquent\Concerns\HasRelationships::hasManyThrough(0), map(['' => '@|\Illuminate\Database\Eloquent\Relations\HasManyThrough',]));
    override(\Illuminate\Database\Eloquent\Concerns\HasRelationships::morphMany(0), map(['' => '@|\Illuminate\Database\Eloquent\Relations\MorphMany',]));
    override(\Illuminate\Database\Eloquent\Concerns\HasRelationships::belongsToMany(0), map(['' => '@|\Illuminate\Database\Eloquent\Relations\BelongsToMany',]));
    override(\Illuminate\Database\Eloquent\Concerns\HasRelationships::morphToMany(0), map(['' => '@|\Illuminate\Database\Eloquent\Relations\MorphToMany',]));
    override(\Illuminate\Database\Eloquent\Concerns\HasRelationships::morphedByMany(0), map(['' => '@|\Illuminate\Database\Eloquent\Relations\MorphToMany',]));
